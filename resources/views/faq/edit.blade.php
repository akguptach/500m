      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Edit <small>FAQ</small></h4>
          </div>
          <div class="card-body">
                ...
                <div class="row">
                  <div class="col-xl-6">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-lg-6">
                        <input type="text" name="question" class="form-control" placeholder="Enter Question" value="{{$data->question}}" required>
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-lg-6">
                        <input type="text" name="answer" class="form-control" placeholder="Enter Answer" value="{{$data->answer}}" required>
                        <div class="invalid-feedback">
                          ..
                        </div>
                      </div>
