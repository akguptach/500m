                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="how_works-tab" data-toggle="tab" data-target="#how_works" type="button" role="tab" aria-controls="how_works" aria-selected="false">How it Works</button>
                                    </li>

                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="why_educrafter-tab" data-toggle="tab" data-target="#why_educrafter" type="button" role="tab" aria-controls="why_educrafter" aria-selected="false">Why EduCrafter</button>
                                    </li>

                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="assist_buttons-tab" data-toggle="tab" data-target="#assist_buttons" type="button" role="tab" aria-controls="assist_buttons" aria-selected="false">Assist You
                                            Buttons</button>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="how_works" role="tabpanel" aria-labelledby="how_works-tab">
                                        @include('services.how_works')
                                    </div>
                                    <div class="tab-pane fade" id="assist_buttons" role="tabpanel" aria-labelledby="assist_buttons-tab">
                                        @include('services.services_assist_btns')
                                    </div>

                                    <div class="tab-pane fade" id="why_educrafter" role="tabpanel" aria-labelledby="why_educrafter-tab">
