    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Create <small>Service</small></h4>
            </div>
            <div class="card-body">
                <!-- Nav tabs -->
                <div class="custom-tab-1">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" data-bs-target="#home1" href="#home1"> Service</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" data-bs-target="#specifications" href="#specifications">Website Content</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" data-bs-target="#ratings" href="#ratings">Ratings</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="pt-4">
                                <form class="needs-validation" method="POST" action="{{route('services.store.basic')}}">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-6">
                                                    <select name="website_type" class="default-select wide form-control">
                                            ...
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom01">Services Name
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" name="service_name" placeholder="Services" required value="{{ old('service_name', @$service->service_name ) }}">
                                                    @error('service_name')
                                                    <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea id="short_description" name="short_description" class="form-control editor">{{ old('short_description', @$service->short_description ) }}</textarea>
                                    ...
                                    <button type="submit" class="btn me-2 btn-primary">Save & next</button>
                        ...
                        <div class="tab-pane fade" id="seo">
                            <div class="pt-4">
                                <form class="needs-validation" id="quickForm" method="POST" action="{{route('services.store.seo')}}" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="service_id" value="{{Request::route('id') }}">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom01">Meta Title
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                            ...
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom01">Meta Description
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom01">Button Title
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="text" name="button_title" class="form-control" placeholder="" value="{{ old('button_title', @$service->seo->button_title ) }}">
                                                    @error('button_title')
                                                    <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="table-responsive table-bordered">
                                                    <form id="basic" method="POST" action="{{route('services.store.faq')}}">
                                                        @csrf
                                                        <input type="hidden" name="service_id" value="{{Request::route('id') }}">
                                                        <table class="table table-bordered table-responsive table-bordered-sm" id="dynamicAddRemove">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                ...
                                                                                <br>
                                                                                <br>
                                                                                <textarea name="addMoreInputFields[{{$index}}][answer]" id="addMoreInputFields[{{$index}}][answer]" placeholder="Enter Answer" class="form-control editor">{{$fileds->answer}}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    </th>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table class="table child-table">
                                                                            <tr>
                                                                                <td>
                                                                                    <input type="text" name="addMoreInputFields[0][question]" id="addMoreInputFields[0][question]" placeholder="Enter Question" class="form-control" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <textarea name="addMoreInputFields[0][answer]" placeholder="Enter Answer" class="form-control editor"></textarea>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                ...
                                                <form id="basic" method="POST" action="{{route('services.store.ratings')}}" enctype="multipart/form-data">
                                                    ...
                                                    <table class="table table-bordered" id="ratingsAddRemove">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="addMoreRatingFields[0][address]" placeholder="Enter Name" class="form-control" require />
                                                            </td>
                                                            <td>
                                    ...
                                    <div class="card-body">
                                        <form id="basic" method="POST" action="{{route('services.store.assist_btn')}}">
                                            ...
                                            <table class="table table-bordered" id="buttonsAddRemove">
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="text" name="addMoreFields[{{$index}}][btn_text]" placeholder="Enter Title" class="form-control" value="{{@$filed['btn_text']}}" require />
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="text" name="addMoreFields[0][btn_text]" placeholder="Enter Button Text" class="form-control" require />
                                                    </td>
                                                    <td>
...
<script>
    $(document).ready(function() {
        ...
        $(window).on("popstate", function() {
            var anchor = location.hash || $('.nav-tabs a[data-bs-toggle="tab"]').first().attr("data-bs-target");
            if (anchor) {
...
<script type="text/javascript">
    ...
    $("#add_more_rating").click(function() {
        ...
        $("#ratingsAddRemove").append(`<tr>
            ...
            <td>
                <input type="text" name="addMoreRatingFields[${i}][address]" placeholder="Enter Name" class="form-control" require />
            </td>
            <td>
