                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Referencing Style</h3>
                            <div class="float-right">
                                <a href="{{ route('referencing.create') }}" class="btn btn-primary">
...
<script>
  $(function () {
    ...
    render: function (data, type, row, meta) {
        ...
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo URL::to('referencing');
;?>"
    } );
  });
  async function delete_style(msg,id){
    if(await confirm(msg)){
        var form = $('#style_form_'+id);
