                ...
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            <input type="hidden" class="form-control" name="addMoreSpecificationFields[{{$index}}][icon_url]" id="ImageIcon_{{@$filed['id']}}" />
                            <button type="button" class="btn btn-primary text-center btnimageModal" rel="{{@$filed['id']}}">
                                Select icon
                            </button>
                            <div class="col-sm-1" >
                                <img src="{{@$filed['icon']}}" alt="Image Description" class="viewImage_{{@$filed['id']}}" style="width: 30px; border-radius: 21px;">
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.btnimageModal', function() {
