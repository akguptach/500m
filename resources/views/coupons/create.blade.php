				...
				<div class="card">
					...
					<div class="card-body">
						<div class="form-validation">
							<form method="POST" class="needs-validation" action="{{ route('coupons.coupon.store') }}" accept-charset="UTF-8" id="create_coupon_form" name="create_coupon_form">
								@csrf
								<div class="row">
									<div class="col-xl-6">
										<div class="mb-3 row">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" value="{{old('code')}}" name="code" type="text" id="code" value="" minlength="1" placeholder="Enter code here..." required>
										...
										<div class="mb-3 row">
											...
											<div class="col-lg-6">
												{{ HtmlHelper::WebsiteDropdown('website_type', old('website_type'), false, '', 'website_type') }}
										...
										<div class="mb-3 row">
											...
											<div class="col-lg-6">
												<input type="text" onkeydown="return false" name="start_date" autocomplete="off" value="{{old('start_date')}}" class="form-control" id="start_date" placeholder="Enter Start Date" required>
										...
										<div class="mb-3 row">
											...
											<div class="col-lg-6">
												<input type="text" onkeydown="return false" name="end_date" autocomplete="off" value="{{old('end_date')}}" class="form-control" id="end_date" placeholder="Enter End Date" required>
										...
										<div class="mb-3 row">
											...
											<div class="col-lg-6">
												<select class="form-control {{ $errors->has('reduction_type') ? ' is-invalid' : '' }}" name="reduction_type" required>
													<option value="">--Select--</option>
													@foreach([['label'=>'Percentage','value'=>'PERCENTAGE'],['label'=>'Fixed','value'=>'FIXED']] as $item)
													<option @if(old('reduction_type')==$item['value']) selected="selected" @endif value="{{$item['value']}}">{{$item['label']}}</option>
													@endforeach
												</select>
										...
										<div class="mb-3 row">
											...
											<div class="col-lg-6">
												<input type="number" class="form-control" value="{{old('reduction_amount')}}" name="reduction_amount" id="" placeholder="Enter Reduction Amount<" required>
												<div class="invalid-feedback">
													....
												</div>
											</div>
								...
								<a href="/coupons" class="btn btn-primary">Back</a>
							</form>
						</div>
					</div>
				</div>
