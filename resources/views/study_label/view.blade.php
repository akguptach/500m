                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Study Label</h3>
                            <div class="float-right">
                                <a href="{{ route('studylabel.create') }}" class="btn btn-primary">
...
<script>
  $(function () {
    $('#example1').DataTable( {
				 "columns": [
                { data: "label_name" },				{ data: "price" },
                { data: "action" }
            ],
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo URL::to('studylabel');
;?>"
    } );
  });
  function delete_label(msg,id){
    if(confirm(msg)){
        var form = $('#study_label_form_'+id);
