            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit <small>Level</small></h4>
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" name="level_name" class="form-control" placeholder="Enter Level Name" value="{{$data->level_name}}" required>
                                                @error('level_name')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
