                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('expert_reviews.expert_review.index',$expert->id) }}" class="btn-sm btn btn-primary">Add Review </a>
                                            </td>
                                            <td class="align-middle">
                                                <a href="{{route('experts.expert.edit',$expert->id)}}" class="edit-link">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form method="POST" action="{!! route('experts.expert.change', $expert->id) !!}" accept-charset="UTF-8" style="display:inline">
                                                    <input name="_method" value="PATCH" type="hidden">
                                                    <input name="status" value="active" type="hidden">
                                                    {{ csrf_field() }}
                                                    <button @if($expert->status=='active') disabled="disabled" @endif
                                                        class="btn btn-link " title="Inactivate Expert"
                                                ...
                                                <form method="POST" action="{!! route('experts.expert.change', $expert->id) !!}" accept-charset="UTF-8" style="display:inline">
                                                    ...
                                                    <button @if($expert->status=='inactive') disabled="disabled" @endif
                                                         class="btn btn-link " title="Activate Expert"
                                                ...
                                                <form method="POST" action="{!! route('experts.expert.destroy', $expert->id) !!}" accept-charset="UTF-8" style="display:inline">
                                                    <input name="_method" value="DELETE" type="hidden">
                                                    {{ csrf_field() }}
                                                    <button class="btn btn-link " title="Delete Student" onclick="return new_modal(event, &quot;Click Ok to delete Expert.&quot;)" style="padding: 0px;padding-bottom:3px;">
