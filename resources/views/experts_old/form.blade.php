...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <textarea name="description" class="editor form-control {{ $errors->has('description') ? ' is-invalid' : '' }}">{{ old('description', optional($expert)->description) }}</textarea>
...
<div class="mb-3 row competences">
    ...
    <div class="col-lg-10 col-xl-9">
        ...
        <select class="form-control {{ $errors->has('competences') ? ' is-invalid' : '' }}" name="competences[]" id="competences" multiple="multiple">
            @if(!empty($subjects))
