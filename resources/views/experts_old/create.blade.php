                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" value="{{ old('first_name') }}" name="first_name" class="form-control" id="validationCustom01" placeholder="Enter first name.." required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" name="rating_numbers" class="form-control" id="validationCustom01" placeholder="Enter Rating number" required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <select id="status" class="default-select wide form-control {{ $errors->has('online_status') ? ' is-invalid' : '' }}" name="online_status">
                                                    ...
                                                    <option value="Online" @if(old('online_status')=='Online' ) selected="selected" @endif>Online</option>
                                                    <option value="Offline" @if(old('online_status')=='Offline' ) selected="selected" @endif>Offline</option>
                                                </select>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" name="qualification" class="form-control" id="validationCustom01" placeholder="qualification.." required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="validationCustom01" name="total_orders" placeholder="Location.." required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="success_rate" id="validationCustom06" placeholder="link" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                @php($competences = old('competences'))
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-10">
                                                <textarea class="form-control" name="description" id="ckeditor" placeholder="link" required></textarea>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div id="paper-type-container">
                                            ...
                                            <div class="mb-3 row paper-row">
                                                <label for="ratingno" class="col-form-label col-lg-2 col-xl-3">@if($p_index == 0) Paper
                                                    @endif</label>
                                                <div class="col-lg-8 col-xl-3 expert_subject1">
