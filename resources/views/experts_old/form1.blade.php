...
<div class="mb-3 row">
    <label for="first_name" class="col-form-label text-lg-end col-lg-2 col-xl-3">Review Title</label>
    <div class="col-lg-10 col-xl-9">
        <input class="form-control"  name="Reviewtitle" type="text" id="" value="" minlength="1" placeholder="Enter Review Title">
        
    </div>
</div>

<div class="mb-3 row">
    <label for="rating" class="col-form-label text-lg-end col-lg-2 col-xl-3">Review Description</label>
    <div class="col-lg-10 col-xl-9">
    <input type="text" class="form-control" name=""  id="" value=""  placeholder="Enter Review Description" id="">      
    </div>
</div>
<div class="mb-3 row">
    <label for="ratingno" class="col-form-label text-lg-end col-lg-2 col-xl-3">Customer ID</label>
    <div class="col-lg-10 col-xl-9">
    <input type="text" class="form-control" name="ratingno"  id="" value=""  placeholder="Enter Customer Id" id="">      
    </div>
</div>


<div class="mb-3 row">
    <label for="date" class="col-form-label text-lg-end col-lg-2 col-xl-3">Date</label>
    <div class="col-lg-10 col-xl-9">
...
<div class="mb-3 row">
    <label for="ratingno" class="col-form-label text-lg-end col-lg-2 col-xl-3">Status</label>
    <div class="col-lg-10 col-xl-9">
    <select id="status" class="form-control" name="status">
            
            <option value="english">Activate</option>
            <option value="hindi">Deactivate</option>      
        </select>    
    </div>
</div>
